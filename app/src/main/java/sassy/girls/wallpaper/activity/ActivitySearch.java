...
import sassy.girls.wallpaper.adapter.AdapterCategory;
import sassy.girls.wallpaper.adapter.AdapterSearch;
import sassy.girls.wallpaper.adapter.AdapterWallpaper;
import sassy.girls.wallpaper.callback.CallbackCategory;
import sassy.girls.wallpaper.callback.CallbackWallpaper;
import sassy.girls.wallpaper.component.ItemOffsetDecoration;
import sassy.girls.wallpaper.database.prefs.AdsPref;
import sassy.girls.wallpaper.database.prefs.SharedPref;
import sassy.girls.wallpaper.model.Category;
import sassy.girls.wallpaper.model.Wallpaper;
import sassy.girls.wallpaper.rest.ApiInterface;
