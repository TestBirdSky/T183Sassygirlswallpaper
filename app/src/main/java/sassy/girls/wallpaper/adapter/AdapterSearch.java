package sassy.girls.wallpaper.adapter;
...
public class AdapterSearch extends RecyclerView.Adapter<AdapterSearch.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder vItem, int position) {
        ...
        if (sharedPref.getIsDarkTheme()) {
            ...
            vItem.title.setTextColor(ContextCompat.getColor(context, R.color.color_dark_text_default));
        } else {
            ...
            vItem.title.setTextColor(ContextCompat.getColor(context, R.color.color_light_text_default));
        }
